        ...
        <div className="grid w-full max-w-5xl gap-8 md:grid-cols-2">
          <div className="rounded-[32px] border border-cyan-400/20 bg-white/[0.04] p-10 shadow-[0_0_80px_rgba(37,99,235,0.18)] backdrop-blur-xl">
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300">
              ...
              will be taken to the plan selection page after login.
            </p>
          </div>
          ...
          <div className="rounded-[32px] border border-cyan-400/20 bg-white/[0.04] p-10 shadow-[0_0_80px_rgba(37,99,235,0.18)] backdrop-blur-xl">
            ...
            >
              ...
              >
                <path
                  fill="#FFC107"
                  d="M43.611 20.083H42V20H24v8h11.303C33.653 32.657 29.23 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.27 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"
                />
                <path
                  fill="#FF3D00"
                ...
                <path
                  fill="#4CAF50"
                  d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.144 35.091 26.671 36 24 36c-5.209 0-9.617-3.321-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z"
                />
                <path
                  fill="#1976D2"
