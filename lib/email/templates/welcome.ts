          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:720px;background:rgba(8,20,42,0.92);border:1px solid rgba(83,175,255,0.18);border-radius:24px;overflow:hidden;">
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td style="padding-right:12px;padding-bottom:10px;">
                      <a href="https://app.auroragrowth.co.uk/signup?utm_source=resend&utm_medium=email&utm_campaign=welcome"
                        style="display:inline-block;background:linear-gradient(90deg,#24d7ee,#8b5cf6);color:#04101f;text-decoration:none;font-weight:700;border-radius:999px;padding:15px 24px;font-size:15px;">Create Your Account</a>
                    </td>
                    <td style="padding-bottom:10px;">
                      <a href="https://app.auroragrowth.co.uk/login?utm_source=resend&utm_medium=email&utm_campaign=welcome"
                        style="display:inline-block;background:rgba(10,20,39,0.82);color:#eaf4ff;text-decoration:none;font-weight:700;border-radius:999px;padding:14px 24px;font-size:15px;border:1px solid rgba(83,175,255,0.28);">Login</a>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:28px 32px 8px 32px;">
                <p style="margin:0;font-size:17px;line-height:1.85;color:#dbe8f8;">Hi ${firstName},</p>
              ...
              <td style="padding:24px 32px 0 32px;">
                <div style="background:linear-gradient(180deg,rgba(8,20,42,0.95),rgba(5,12,24,0.94));border:1px solid rgba(83,175,255,0.16);border-radius:22px;padding:24px;">
                  ...
                  <div style="color:#eaf4ff;font-size:16px;line-height:1.9;">
                    • Find stronger opportunities with the Market Scanner<br>
                    • Plan entries and pullbacks with the Investment Calculator<br>
                    • Track live and demo watchlists separately<br>
                    • Set alerts and Telegram notifications<br>
                    • Understand the market with the Heatmap<br>
                    • Learn the platform through the Aurora Assistant
                  </div>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:30px 32px 0 32px;">
                <div style="background:
                  ...
                  <a href="https://app.auroragrowth.co.uk/signup?utm_source=resend&utm_medium=email&utm_campaign=welcome"
                    style="display:inline-block;background:linear-gradient(90deg,#24d7ee,#8b5cf6);color:#04101f;text-decoration:none;font-weight:700;border-radius:999px;padding:16px 26px;font-size:16px;">Create Your Account</a>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:28px 32px 34px 32px;text-align:center;font-size:14px;line-height:1.8;color:#88a1bb;">
                Best regards,<br>
                <strong style="color:#eaf4ff;">Paul</strong><br>
                Aurora Growth Academy
              </td>
            </tr>
